    ...
    <>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .bv-sidebar.open ~ .bv-overlay {
            display: block;
          }
        }
      `}</style>

      <aside className="bv-sidebar" id="bv-sidebar">
        {/* Logo */}
        <div style={{ padding: "20px 24px", borderBottom: "1px solid #2a2a2a", textAlign: "center" }}>
          <img
          ...
          />
          <div style={{ fontSize: 9, color: "#C9A84C", letterSpacing: "0.4em", textTransform: "uppercase", marginTop: 8 }}>
            REVIEWS
          </div>
        </div>
        ...
        <div style={{ padding: "12px 8px", borderTop: "1px solid #2a2a2a" }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13, color: "#888", transition: "all 0.15s ease",
            }}
            onMouseEnter={(e) => {
